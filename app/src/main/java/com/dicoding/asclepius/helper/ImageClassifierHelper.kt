...
class ImageClassifierHelper(
    ...
    val classifierListener: ImageClassifierListener? = null
) {
    ...
    fun classifyStaticImage(imageUri: Uri) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.P) {
            val imageSrc = ImageDecoder.createSource(context.contentResolver, imageUri)
            ImageDecoder.decodeBitmap(imageSrc)
        } else {
